...
const {get_home_patient,get_start_test,post_start_test,get_mydoctor,get_question,update_test_status,get_test_details,update_paused_hint}=require("../controllers/patient")
...
router.put("/test/update_hints/:id",isLoggedIn, isPatient,isTestAssigned,update_paused_hint)
