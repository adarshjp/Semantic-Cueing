...
const {admin_get,view_patient,view_doctor,view_Oneuser,get_edit_user,edit_user,delete_user,checkusername,get_details_for_graph} = require('../controllers/admin')
...
router.get("/data/users",get_details_for_graph)
