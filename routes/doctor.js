...
router.get("/data/patientdetails/:patinetId", isLoggedIn, isDoctor, isMappedDoctor,get_patient_details); // gets the details of particular patient
router.get("/data/testdetails/:patinetId", isLoggedIn, isDoctor,isMappedDoctor, get_patient_test_details); // gets the details of particular patient
...
router.put("/inclevel/:patinetId", isLoggedIn, isDoctor, isMappedDoctor,upgrade_level);
router.put("/drelevel/:patinetId", isLoggedIn, isDoctor,isMappedDoctor,downgrade_level);
router.put("/discharge/:patinetId", isLoggedIn, isDoctor,isMappedDoctor, discharge_patient);
